...
This module regenerates initramfs only once during build process, while `rpm-ostree initramfs` & `rpm-ostree initramfs-etc` regenerates it every update locally in the user's system.
